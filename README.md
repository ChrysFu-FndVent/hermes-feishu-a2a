...
[![CI](https://github.com/ChrysFu-FndVent/hermes-feishu-a2a/actions/workflows/ci.yml/badge.svg)](https://github.com/ChrysFu-FndVent/hermes-feishu-a2a/actions/workflows/ci.yml)
...
Version tags such as `v0.1.0` publish two distribution formats automatically:

- a GitHub Release containing the Python wheel, source distribution and SHA-256 checksums;
- a multi-platform container image in GitHub Container Registry.

Pull the latest container with:

```bash
docker pull ghcr.io/chrysfufndvent/hermes-feishu-a2a:latest
```

Tagged images use the release version, for example
`ghcr.io/chrysfufndvent/hermes-feishu-a2a:0.1.0`.
